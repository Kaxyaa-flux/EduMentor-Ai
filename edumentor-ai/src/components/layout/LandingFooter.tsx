        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Features</Link></li>
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Curriculum</Link></li>
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Pricing</Link></li>
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Changelog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Documentation</Link></li>
              ...
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-400">
              ...
              <li><Link href="#" className="hover:text-[#10B981] transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
